...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/hospital/hPatient/">病人信息列表</a></li>
		<li class="active"><a href="${ctx}/hospital/hPatient/form?id=${hPatient.id}">病人信息<shiro:hasPermission name="hospital:hPatient:edit">${not empty hPatient.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="hospital:hPatient:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="hPatient" action="${ctx}/hospital/hPatient/save" method="post" class="form-horizontal">
		...
		<div class="form-actions">
			<shiro:hasPermission name="hospital:hPatient:edit"><input id="btnSubmit" class="btn btn-primary" type="submit" value="保 存"/>&nbsp;</shiro:hasPermission>
