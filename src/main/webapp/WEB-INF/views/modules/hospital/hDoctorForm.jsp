...
<body>
	...
	<form:form id="inputForm" modelAttribute="hDoctor" action="${ctx}/hospital/hDoctor/save" method="post" class="form-horizontal">
		...
		<div class="control-group">
			...
			<div class="controls">
				<sys:treeselect id="user" name="user.id" value="${hDoctor.user.id}" labelName="user.name" labelValue="${hDoctor.user.name}"
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:input path="jobNumber" htmlEscape="false" maxlength="64" class="input-xlarge "/>
			</div>
		</div>
		<div class="control-group">
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:input path="doctorDuty" htmlEscape="false" maxlength="64" class="input-xlarge "/>
			</div>
		</div>
		<div class="control-group">
